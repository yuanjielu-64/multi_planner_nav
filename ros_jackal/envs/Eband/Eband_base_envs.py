...
from envs.utils import GazeboSimulation, Eband_move_base, JackalRos
...
class DWABase(gym.Env):
    ...
    def _set_start_goal_BARN(self, init_position, goal_position):
        ...
        self.jackal_ros = JackalRos(init_position = init_position, goal_position = goal_position, use_move_base = True, img_dir = self.img_dir)
