...
class Eband_move_base():
    ...
    def __init__(self, goal_position=[6, 6, 0], base_local_planner="base_local_planner/TrajectoryPlannerROS"):
        ...
        self.sub_collision = rospy.Subscriber("/collision", Bool, self.robot_config._collision_cb)
    ...
    def get_navi_param(self, param_name):
        if param_name != 'inflation_radius':
            ...
            param = rospy.get_param('/move_base/global_costmap/inflation_layer/' + param_name)
        return param
    ...
    def get_collision(self):
        ...
        return self.collision_flag or d < 0.01
